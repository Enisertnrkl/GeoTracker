...
namespace GeoTrackerClient
{
    public partial class MainPage : ContentPage
    {
        private bool isTimerRunning = false;
        private string connectionString = "Server=10.147.17.3;User Id=enis.ertnrkl;Password=402624;Database=GeoTracker;TrustServerCertificate=True";
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand(
                               ...
                               "UPDATE Locations SET Latitude = @latitude, Longitude = @longitude, Timestamp = @timestamp WHERE UserId = @userId " +
                               "ELSE " +
                               "INSERT INTO Locations (UserId, Latitude, Longitude, Timestamp) VALUES (@userId, @latitude, @longitude, @timestamp)", connection))
                    {
